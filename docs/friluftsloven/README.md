...
Allmennhetens ferdselsrett i utmark, og grensesnittet mot privat veg og skilting.
...
| **Utgiver** | Lovdata |
| **LovId** | `1957-06-28-16` |
| **Original på nett** | <https://lovdata.no/dokument/NL/lov/1957-06-28-16> |
...
| **Kildefil i datasettet** | `nl-19570628-016.xml` |
| **Hentet** | 04.08.2026 |
| **SHA256 (lokal snapshot)** | `8E637735DB93A37A8E81217D60BC97E3280EC03C440465F907CAFDB281895769` |
...
`friluftsloven.xml` i denne mappa er derfor ikke en fil Lovdata har publisert et
...
`scripts/Update-Lovtekst.ps1 friluftsloven -GodtaNyVersjon -Skriv` for å ta inn
...
| 2 | [friluftsloven.xml](friluftsloven.xml) | Lokal snapshot av lovens XML fra Lovdata sitt datasett, slik den sto ved hentingen over. |
| 3 | [friluftsloven.md](friluftsloven.md) | Maskingenerert markdown av XML-en. Denne leses og diffes. |
...
```powershell
./scripts/Update-Lovtekst.ps1 friluftsloven -Skriv
```
...
`README.md` og frontmatter i `friluftsloven.md`.
