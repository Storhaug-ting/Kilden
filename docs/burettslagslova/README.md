...
Organisering av burettslag: vedtekter, årsmøte og felleskostnader — en sammenlignbar organisasjonsmodell til veglag.
...
| **Utgiver** | Lovdata |
| **LovId** | `2003-06-06-39` |
| **Original på nett** | <https://lovdata.no/dokument/NL/lov/2003-06-06-39> |
...
| **Kildefil i datasettet** | `nl-20030606-039.xml` |
| **Hentet** | 04.08.2026 |
| **SHA256 (lokal snapshot)** | `B36FF234DED0867B002BC2B0112437018BCDD2667A40EFC06E6984A7DFDF0EC2` |
...
`burettslagslova.xml` i denne mappa er derfor ikke en fil Lovdata har publisert et
...
`scripts/Update-Lovtekst.ps1 burettslagslova -GodtaNyVersjon -Skriv` for å ta inn
...
| 2 | [burettslagslova.xml](burettslagslova.xml) | Lokal snapshot av lovens XML fra Lovdata sitt datasett, slik den sto ved hentingen over. |
| 3 | [burettslagslova.md](burettslagslova.md) | Maskingenerert markdown av XML-en. Denne leses og diffes. |
...
```powershell
./scripts/Update-Lovtekst.ps1 burettslagslova -Skriv
```
