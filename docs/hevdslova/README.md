...
Regler for hevd av rettar, herunder brukshevd av vegrett der et skriftlig stiftelsesgrunnlag mangler.
...
| **Utgiver** | Lovdata |
| **LovId** | `1966-12-09-1` |
| **Original på nett** | <https://lovdata.no/dokument/NL/lov/1966-12-09-1> |
...
| **Kildefil i datasettet** | `nl-19661209-001.xml` |
| **Hentet** | 04.08.2026 |
| **SHA256 (lokal snapshot)** | `E2CC6B793C2E422685F9A4F3E86ECF14CF6E7E37739B8B3CC4D3FEC3247C9C32` |
...
`hevdslova.xml` i denne mappa er derfor ikke en fil Lovdata har publisert et
...
`scripts/Update-Lovtekst.ps1 hevdslova -GodtaNyVersjon -Skriv` for å ta inn
...
| 2 | [hevdslova.xml](hevdslova.xml) | Lokal snapshot av lovens XML fra Lovdata sitt datasett, slik den sto ved hentingen over. |
| 3 | [hevdslova.md](hevdslova.md) | Maskingenerert markdown av XML-en. Denne leses og diffes. |
...
```powershell
./scripts/Update-Lovtekst.ps1 hevdslova -Skriv
```
...
`README.md` og frontmatter i `hevdslova.md`.
