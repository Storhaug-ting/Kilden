...
Loven regulerer hva en nabo må tåle fra naboeiendommen: tålegrensen i § 2, tre
og hekk nær grensa (§ 3), takdrop og veggåpninger (§ 4), forsvarlige
forholdsregler ved graving, bygging og sprengning (§ 5), plikten til å varsle
naboen i rimelig tid før tiltaket settes i verk (§ 6), granneskjønn (§§ 7–8),
erstatning (§ 9) og retting (§§ 10–12). Sammen med grannegjerdelova utgjør den
naboretten som ligger under tvister om veg, gjerde og tiltak langs
eiendomsgrenser.
...
| **Utgiver** | Lovdata |
| **LovId** | `1961-06-16-15` |
| **Original på nett** | <https://lovdata.no/dokument/NL/lov/1961-06-16-15> |
...
| **Kildefil i datasettet** | `nl-19610616-015.xml` |
| **Hentet** | 05.08.2026 |
| **SHA256 (lokal snapshot)** | `6DA513F10224BF26353EB6D8AA73252963CB231347B073B78A2241DC3444A3E1` |
...
`grannelova.xml` i denne mappa er derfor ikke en fil Lovdata har publisert et
...
`scripts/Update-Lovtekst.ps1 grannelova -GodtaNyVersjon -Skriv` for å ta inn
...
| 2 | [grannelova.xml](grannelova.xml) | Lokal snapshot av lovens XML fra Lovdata sitt datasett, slik den sto ved hentingen over. |
| 3 | [grannelova.md](grannelova.md) | Maskingenerert markdown av XML-en. Denne leses og diffes. |
...
```powershell
./scripts/Update-Lovtekst.ps1 grannelova -Skriv
```
...
`README.md` og frontmatter i `grannelova.md`.
